...
var LocationProvider = require("./../../providers/location");
...
var Location = classCreator("Location", Emitter, {
    ...
    subscribe: function (_connectionId, _responseId) {
        this._createLocationSubscriber().then(function(){
    ...
    // ======== PROVIDERS PART =======
    _createLocationProvider: function  () {
    ...
    // ======== SUBSCRIBERS PART =======
    _createLocationSubscriber: function () {
